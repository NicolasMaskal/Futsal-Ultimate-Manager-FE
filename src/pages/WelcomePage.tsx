        ...
        <Grid item xs={8}>
          <Box component="article" sx={{ px: mobileView ? 2 : 8 }}>
            ...
            <p>
              ...
              by viewing your players and past matches. Test your team's mettle against
              our AI opponents by simulating matches.
            </p>
            <p>
              And that's not all - there's even more to discover. Don't have an account
              yet?{" "}
